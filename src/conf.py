...
# Commented out and moved to file `conf.mk`:
#
# # General information about the project.
# project = 'pseudomat'
#
# # noinspection PyShadowingBuiltins
# copyright = '2018–2019, DjinnIT'
...
for inventory in intersphinx_mapping:
    if not os.path.exists(intersphinx_mapping[inventory][1]):
        ...
        with open(intersphinx_mapping[inventory][1], 'wb') as _f:
            for _chunk in _r.iter_content(chunk_size=4096):
                _f.write(_chunk)
    if not os.path.exists(intersphinx_mapping[inventory][1] + '.txt') or os.path.getsize(intersphinx_mapping[inventory][1] + '.txt') == 0:
        os.system(
            """
                {{
